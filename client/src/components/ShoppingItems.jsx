...
import { useAddToCart } from "../hooks/productHook";
        ...
        {item?.map((data) => (
          ...
          >
            ...
            <div className="text-center ">
              <button
                className="bg-red-500 h-11 w-56 pl-12 text-white flex justigy-center items-center  rounded-md shadow-md transition-colors duration-300 hover:bg-red-600"
